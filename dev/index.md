...
If you use the [anthrocheckr](https://nutriverse.io/anthrocheckr/)
package in your work, please cite using the suggested citation provided
by a call to the [`citation()`](https://rdrr.io/r/utils/citation.html)
function as follows:
...
Please note that the [anthrocheckr](https://nutriverse.io/anthrocheckr/)
